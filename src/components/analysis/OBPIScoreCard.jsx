      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2">
            ...
            <OBPIStyleBadge style={analysis.obpi_style} />
          </div>
        </div>
        <div className="rounded-md border border-slate-700 bg-slate-950 px-5 py-4">
          ...
          <div className="mt-1 text-2xl font-semibold text-white">{analysis.percentile ? formatPercentile(analysis.percentile) : "N/A"}</div>
        </div>
      </div>
    </section>
  );
